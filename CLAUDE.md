...
This project is indexed by GitNexus as **voice-layer** (2695 symbols, 5802 relationships, 238 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
