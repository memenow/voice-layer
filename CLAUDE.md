...
This project is indexed by GitNexus as **voice-layer** (2540 symbols, 5508 relationships, 225 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
